      ...
      >
        <div className="h-full w-full">
          ...
          <div className="absolute w-full " >
            {/* header */}
            <div className="px-[75px]  py-2  flex justify-between items-center fixed top-0 left-0 w-full bg-transparent z-50" style={headerStyle} >
              ...
              <div className="flex gap-[26px]">
                <div className="flex gap-[11px]">
                  ...
                  <p className="text-white text-[19px]">ajithjoshep@singaar.in</p>
                </div>
                <div className="flex gap-[11px]">
