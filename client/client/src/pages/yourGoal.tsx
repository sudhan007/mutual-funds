        ...
        <div className="mt-[124px]">
            <div className="flex flex-col justify-center items-center">
                <div className="flex flex-col items-center justify-center gap-[31px]">
                    ...
                    <p className="text-[42px] bg-[linear-gradient(91.73deg,#1B2EA1_48.22%,#090F34_127.67%)] bg-clip-text text-transparent text-[42px] font-bold"> Identify your Goal</p>
                </div>
    ...
    <div>
        ...
        <ChartContainer config={chartConfig} className="min-h-[200px] w-full">
                                    <BarChart data={chartData} width={400} height={300}>
                                        ...
                                        <XAxis dataKey="name" tickLine={false} axisLine={{ stroke: '#000' }} /> {/* Show X-axis */}
                                        ...
                                        <line x1="0" y1={290} x2="400" y2={290} stroke="#000" strokeWidth="2" /> {/* Baseline */}
