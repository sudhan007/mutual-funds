...
export default function Partners() {
  ...
  const images = [
    {
      src: HDFC,
      alt: 'HDFC Mutual Fund',
      width: 'w-[90px] lg:w-[150px]',
      height: 'h-[32px] lg:h-[50px]',
    },
    {
      src: Mirae,
      alt: 'Mirae Asset Financial Service',
      width: 'w-[110px] lg:w-[184px]',
      height: 'h-[34px] lg:h-[56px]',
    },
    {
      src: ICICI,
      alt: 'ICICI Prudential',
      width: 'w-[180px] lg:w-[303px]',
      height: 'h-[22px] lg:h-[36px]',
    },
    {
      src: Navi,
      alt: 'Navi Mutual Fund',
      width: 'w-[116px] lg:w-[194px]',
      height: 'h-[35px] lg:h-[59px]',
    },
    {
      src: Nippon,
      alt: 'Nippon Mutual Fund',
      width: 'w-[202px] lg:w-[338px]',
      height: 'h-[38px] lg:h-[63px]',
    },
    {
      src: Motilal,
      alt: 'Motilal Oswal Mutual Fund',
      width: 'w-[67px] lg:w-[112px]',
      height: 'h-[27px] lg:h-[44px]',
    },
    {
      src: Quant,
      alt: 'Quant',
      width: 'w-[92px] lg:w-[154px]',
      height: 'h-[42px] lg:h-[70px]',
    },
    {
      src: Bandhan,
      alt: 'Bandhan Mutual Fund',
      width: 'w-[88px] lg:w-[147px]',
      height: 'h-[30px] lg:h-[49px]',
    },
  ];
  ...
  return (
    <div className="lg:mt-[130px] mt-[55px] mx-0 2xl:mx-[200px] flex justify-center items-center flex-col">
      <div>
        <h1 className="text-[#667085] text-[30px]">
          Our Distribution Partners
        </h1>
      </div>
      <div className="lg:mt-[60px]  mt-[70px]">{renderImages()}</div>
    </div>
  );
}
