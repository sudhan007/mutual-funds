...
export default function Header({ aboutRef }: HeaderProps) {
  ...
  const handleScroll = () => {
    ...
    if (scrollY > 50) {
      setHeaderStyle({
        // backgroundColor: 'linear-gradient(149.33deg, #0A155B 0.87%, #060D34 94.27%)',
          ...
          <div className="absolute w-full ">
            ...
            <div
              ...
              <div className="flex items-center md:pl-0 pl-[23px] gap-[20px]">
                <img src={Logo} alt="" className="lg:w-[110px]  w-16" />
                <p className="text-white text-[28px]  hidden md:block ">
                  Singaar Wealth
                </p>
              </div>
                ...
                <a
                  ...
                  <div className="flex gap-[5px] justify-center items-center">
                    <img
                      src={Mail}
                      alt=""
                      className="md:w-[29px] md:h-[29px] h-[14px] w-[18px]"
                    />
                ...
                <a
                  ...
                  <div className="flex justify-center items-center gap-[5px]">
                    <img
                      src={Phone}
                      alt=""
                      className="md:w-[29px]  md:h-[29px] h-[16px] w-[17px]"
                    />
                    +91 9090717130
                  </div>
                </a>
              ...
              <div className="lg:w-3/4 w-full  mt-16">
                ...
                <div>
                  <p className="text-[#B3B6BD]  justify-center items-center mt-10 lg:text-[28px] text-[20px] flex lg:flex-row flex-col">
                    <span>A Mutual Fund Distributor :</span>
                    <span>ARN-306053</span>
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-row justify-between items-end w-full">
              <div>
                <img
                  src={leftbar}
                  alt=""
                  className="md:h-[300px] md:w-[210px]  h-[200px] w-[140px]"
                />
              </div>
              <div>
                <img
                  src={rightbar}
                  alt=""
                  className="md:h-[200px] md:w-[100px] h-[130px] w-[70px]"
                />
              </div>
            </div>
          </div>
